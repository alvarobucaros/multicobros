...
function AnticiposForm(props) {
  ...
  //  http://localhost:3000/api/usuarios?e=2&op=abono
    ...
    return (
      ...
      <main className="form-signin w-900 m-auto">
        <form onSubmit={handledSubmit}>
        <div className="mb-1 row">

          <div className="d-flex align-items-sm-center mb0">
            <label className="col-sm-4 col-form-label" htmlFor="us_nombre">Deudor :</label>
                       
              <select id='us_nombre' name='us_nombre' className="form-control col-sm-10 ancho200" 
